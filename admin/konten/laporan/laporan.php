...
<?php
    ...
    if (isset($_POST['filter-transaksi'])) {
        ...
        $temp_no_transaksi=$no_transaksi;
...
<?php
    ...
    if (isset($_POST['filter'])) {
        ...
        $temp_tangga1=$tanggal1;
        $temp_tangga2=$tanggal2;
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php
                if ($temp_no_transaksi != "") {
                ?>
                <a href="?m1=laporan&m2=cetak&id_transaksi=<?= $temp_no_transaksi ?>" target="_blank" class="
                        btn btn-success btn-warning fa fa-print"></a>
                <?php
                }elseif($temp_tangga1 != "" && $temp_tangga2 != ""){
                ?>
                <a href="?m1=laporan&m2=cetak&tanggal1=<?= $tanggal1 ?>&tanggal2=<?= $tanggal2 ?>" target="_blank" class="
                        btn btn-success btn-warning fa fa-print"></a>
                <?php
                }else{
                ?>
                  <a href="?m1=laporan&m2=cetak" target="_blank" class="
                        btn btn-success btn-warning fa fa-print"></a>
                <?php
                }
                ?>
