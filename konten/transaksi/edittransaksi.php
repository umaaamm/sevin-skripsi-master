...
if (isset($_POST['submit'])) {
   $id_konsumen = $_POST['id_konsumen'];
    ...
    $query_tambah = $koneksi->query("UPDATE transaksi SET id_konsumen='" . $id_konsumen . "',jumlah_angsuran='" . $jumlah_angsuran . "',jumlah_pinjaman='" . $jumlah_pinjaman . "',angsuran='" . $angsuran . "',tanggal_jatuh_tempo='".$tanggal."' where id_transaksi='" . $id_edit . "'  ");
...
<div class="form-group">
                        ...
                        <div class='input-group date' id='datepicker'>
                            <input type='text' class="form-control" value="<?= $tampil_edit['tanggal_jatuh_tempo'] ?>" name="tanggal"/>
