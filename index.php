...
<head>
  ...
  <title>Sistem Pengolahan Data Konsumen PT. Federal Internasional Finance</title>
...
<body class="hold-transition skin-red sidebar-mini">
  ...
  <strong>PEMINJAMAN</strong>
      ...
      <span class="logo-mini"><b>PEMINJAMAN</b></span>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <?php
          $query=$koneksi->query("SELECT * from konsumen where id_konsumen='".$_SESSION['id_konsumen']."' ");
          $tmpl=$query->fetch_assoc();
          ?>
          <p><?php echo $tmpl['nama_konsumen']?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">    
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="?m1=konsumen&m2=datakonsumen"><i class="fa fa-circle-o"></i>Data Konsumen</a></li>   
            <li class="active"><a href="?m1=transaksi&m2=transaksi"><i class="fa fa-circle-o"></i> Kelola Transaksi</a></li>
            <li class="active"><a href="?m1=pembayaran&m2=pembayaran"><i class="fa fa-circle-o"></i> Kelola Pembayaran</a></li>
            ...
            ?>
            <li class="active"><a href="?m1=laporan&m2=laporan_user"><i class="fa fa-circle-o"></i> Laporan User</a></li> 
            <li class="active"><a href="logout.php"><i class="fa fa-circle-o"></i> Logout</a></li> 
            <?php } ?>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 | Sevin.</strong> All rights
    reserved.
  </footer>
