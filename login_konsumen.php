...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Silahkan Login Konsumen</h3>
                    </div>
        ...
        {
            $no_ktp=$_POST['no_ktp'];
            $querylogin=$koneksi->query("select * from konsumen where no_ktp='".$no_ktp."' ");
        ...
        ?>
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="No KTP" name="no_ktp" type="text" autofocus>
                                </div>
